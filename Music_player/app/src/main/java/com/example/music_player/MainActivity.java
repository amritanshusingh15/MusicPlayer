...
public class MainActivity extends AppCompatActivity {
    String[] items;
    ListView mylistofsongs;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        mylistofsongs=(ListView) findViewById(R.id.songlistview);
        runtimepermission();
    }
    ...
    void display(){
        ...
        mylistofsongs.setAdapter(myadaptor);


        mylistofsongs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String songname=mylistofsongs.getItemAtPosition(position).toString();
